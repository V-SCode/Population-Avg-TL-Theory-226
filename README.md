...
order-parameter reductions of the adaptive kernel with Marchenko–Pastur deter-
ministic equivalents for ridge regression, we obtain an explicit population-level
